...
# Show Marvel + DC titles with 15x2 button layout
async def show_marvel(update: Update, context: ContextTypes.DEFAULT_TYPE, page=1):
    ...
    await update.message.reply_text("🦸‍♂️ Choose Marvel or DC Title:", reply_markup=ReplyKeyboardMarkup(keyboard, resize_keyboard=True))
