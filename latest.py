...
# Show Latest titles with 15x2 button layout
async def show_latest(update: Update, context: ContextTypes.DEFAULT_TYPE, page=1):
    ...
    await update.message.reply_text("🆕 Latest Uploads:", reply_markup=ReplyKeyboardMarkup(keyboard, resize_keyboard=True))
