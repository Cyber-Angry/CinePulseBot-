...
# Show Multi-Part Movies with 15x2 button layout
async def show_multiparts(update: Update, context: ContextTypes.DEFAULT_TYPE, page=1):
    ...
    await update.message.reply_text("🎬 Choose a Multi-Part Movie:", reply_markup=ReplyKeyboardMarkup(keyboard, resize_keyboard=True))

# Handle Multi-Part selection
