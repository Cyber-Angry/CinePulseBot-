...
# Show Anime titles with 15x2 button layout
async def show_anime(update: Update, context: ContextTypes.DEFAULT_TYPE, page=1):
    ...
    await update.message.reply_text("🎌 Choose an Anime:", reply_markup=ReplyKeyboardMarkup(keyboard, resize_keyboard=True))
